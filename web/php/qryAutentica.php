...
if(isset($_POST["btnEnviar"])) //Comprueba si el botón de envío de formulario con el nombre btnEnviar ha sido presionado
{
    ...
    $strQry="select * from alumnos where
                num_Control= '".mysqli_real_escape_string($link,$_usr)."' and
    ...
    $usr = $registro['num_Control']; //Crea una variable de PHP llamada $usr y asigna el valor del campo usr del registro obtenido
